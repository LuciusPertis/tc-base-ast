...
namespace misc
{
  ...
  requires VariantTypes<T, Ts...> template <typename U>
  ...
  template <typename T, typename... Ts>
  requires VariantTypes<T, Ts...> template <typename V>
  ...
  template <typename T, typename... Ts>
  requires VariantTypes<T, Ts...> template <typename V, class... Variants>
