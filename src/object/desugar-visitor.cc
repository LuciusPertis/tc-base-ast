...
namespace object
{
  ...
  {
    parse::Tweast input;
    const misc::symbol& static_type_name = class_names_(static_type);
                                           ...
                                           parse::Tweast* input)
  {
    ...
    if (class_type->has_data())
      {
        const misc::symbol& class_name = class_names_(class_type);
        *input << ",\n"
  ...
  {
    parse::Tweast input;
    const misc::symbol& method_name = method->name_get();
  ...
  // FIXME: Some code was deleted here (Initialize attr).
              const misc::symbol& attr_name = attr->name_get();
  ...
  void DesugarVisitor::handle_class(const ast::TypeChunk& e,
                                    ...
                                    dispatch_list_type& sub_dispatches)
  {
    const misc::symbol& class_name = class_names_(cls);
