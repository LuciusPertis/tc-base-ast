...
namespace parse
{
  ...
  inline ast::SimpleVar*
  TigerDriver::make_SimpleVar(const location& location,
                              const misc::symbol& name) const
  {
    return new ast::SimpleVar(location, name);
  }

  inline ast::CastVar* TigerDriver::make_CastVar(const location& location,
                                                 ast::Var* var,
                                                 ast::Ty* ty) const
  {
    return new ast::CastVar(location, var, ty);
  }

  inline ast::FieldVar*
  TigerDriver::make_FieldVar(const location& location,
                             ast::Var* var,
                             const misc::symbol& name) const
  {
