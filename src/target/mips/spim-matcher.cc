 ...
 ** \brief Implementation of target::mips::SpimMatcher.
 **/
...
{
  SpimMatcher::SpimMatcher(SpimCodegen* cg)
    : cg_(cg)
  {}

  void SpimMatcher::operator()(tree::rBinop binop)
  {
  ...
  void SpimMatcher::operator()(tree::rCall call)
  {
    TRACE("call: Call");
  ...
  void SpimMatcher::operator()(tree::rConst cst)
  {
    TRACE("exp: Const");
    EMIT(ASSEMBLY.move_build(cst->value_get(), cst->asm_get()));
  }

  void SpimMatcher::operator()(tree::rMem mem)
  {
  ...
  void SpimMatcher::operator()(tree::rName name)
  {
    TRACE("exp: Name");
    EMIT(ASSEMBLY.move_build(name->label_get(), name->asm_get()));
  }

  void SpimMatcher::operator()(tree::rTemp temp)
  {
    TRACE("temp: Temp");
    temp->asm_set(temp->temp_get());
  }

  void SpimMatcher::operator()(tree::rCjump cjump)
  {
  ...
  void SpimMatcher::operator()(tree::rJump jump)
  {
    TRACE("stm: Jump");
  ...
  void SpimMatcher::operator()(tree::rLabel label)
  {
    TRACE("stm: Label");
    EMIT(ASSEMBLY.label_build(label->label_get()));
  }

  void SpimMatcher::move_load(tree::rExp exp, tree::rBinop binop)
  {
    REDUCE(exp);
  ...
  void SpimMatcher::move_store(tree::rExp exp, tree::rBinop binop)
  {
    REDUCE(exp);
  ...
  void SpimMatcher::operator()(tree::rMove move)
  {
  ...
  void SpimMatcher::operator()(tree::rSeq seq)
  {
    TRACE("stm: Seq");
  ...
  void SpimMatcher::operator()(tree::rSxp sxp)
  {
    TRACE("stm: Sxp(exp)");
    REDUCE(sxp->exp_get());
  }
