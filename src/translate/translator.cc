...
namespace translate
{
  ...
  void Translator::operator()(const ast::VarChunk& e)
  {
  ...
  void Translator::operator()(const ast::TypeChunk&) {}

  void Translator::operator()(const ast::FunctionChunk& e)
  {
    for (const ast::FunctionDec* fdec : e)
  ...
  void Translator::visit_function_dec_header(const ast::FunctionDec& e)
  {
    if (!e.body_get())
    ...
    else
      {
        ...
        fun_level_[&e] = new Level(e.name_get(), level_, e.escapes_get());
  ...
  void Translator::visit_function_dec_body(const ast::FunctionDec& e)
  {
    ...
    auto k = level_->formals_get().begin();
